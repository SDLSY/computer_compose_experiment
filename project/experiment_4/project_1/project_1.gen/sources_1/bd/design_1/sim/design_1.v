...
module design_1
  ...
  design_1_and2_3_0 and2_3
       (.a(adpt_in_0_a1),
        .b(adpt_in_0_LM),
        .y(and2_3_y));
  design_1_and2_0_1 and2_4
       (.a(adpt_in_0_a2),
        .b(adpt_in_0_DM),
        .y(and2_4_y));
  design_1_and2_1_1 and2_5
       (.a(adpt_in_0_a3),
        .b(adpt_in_0_RM),
        .y(and2_5_y));
  design_1_and2_2_1 and2_6
       (.a(adpt_in_0_a0),
        .b(adpt_in_0_LM),
        .y(and2_6_y));
  design_1_and2_0_2 and2_7
       (.a(adpt_in_0_a1),
        .b(adpt_in_0_DM),
        .y(and2_7_y));
  design_1_and2_1_2 and2_8
       (.a(adpt_in_0_a2),
        .b(adpt_in_0_RM),
        .y(and2_8_y));
  design_1_and2_2_2 and2_9
       (.a(xlconstant_0_dout),
        .b(adpt_in_0_LM),
        .y(and2_9_y));
